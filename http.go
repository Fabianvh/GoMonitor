...
func lastStatus(statusAtTime []*statusAtTime) string { //Controleert laatste status van http
	if len(statusAtTime) == 0 {
...
func RunHttp(address string, monitor *Monitor) { //Start index.html vanuit server
...
<html lang="en">
  <head>
	...
	<title>vhekke.nl - Monitoring</title>
  ...
  <body>
	<div class="container">
		<br>
		<center><h1>VHekke.nl - Monitoring</h1></center>
		<hr>
		<div class="row">
